...
from direct.nn.utils import compute_model_per_coil, compute_resolution, cropper
...
class RIMEngine(Engine):
    ...
    def _do_iteration(
        ...
        if "sensitivity_model" in self.models:
            ...
            sensitivity_map = compute_model_per_coil(
    ...
    def build_loss(self, **kwargs) -> Dict:
        ...
        def l1_loss(source, reduction="mean", **data):
            ...
            l1_loss = F.l1_loss(*cropper(T.modulus(source), data["target"], resolution), reduction=reduction)
        ...
        def ssim_loss(source, reduction="mean", **data):
            ...
            source_abs, target_abs = cropper(T.modulus(source), data["target"], resolution)
