...
class GPSA(nn.Module):
    ...
    def get_attention_map(
        self, x: torch.Tensor, return_map: Optional[bool] = False
...
class MHSA(nn.Module):
    ...
    def __init__(
        self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0.0, proj_drop=0.0, grid_size=None
    ) -> None:
        """Inits :class:`MHSA`.
    ...
    def get_attention_map(self, x, return_map=False) -> torch.Tensor | tuple[torch.Tensor, torch.Tensor]:
